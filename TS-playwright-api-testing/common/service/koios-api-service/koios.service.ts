import { KoiosGetAccountAddressesDto } from "@api-common/dtos/koios/account/koios-get-account-addresses.dto";
import { KoiosGetAccountTransactionDto } from "@api-common/dtos/koios/account/koios-get-account-transaction.dto";
import { KoiosGetAssetHistoryDto } from "@api-common/dtos/koios/asset/koios-get-asset-history.dto";
import { KoiosGetAssetUtxoDto } from "@api-common/dtos/koios/asset/koios-get-asset-utxo.dto";
import { KoiosGetBlockListDto } from "@api-common/dtos/koios/block/koios-get-block-list.dto";
import { KoiosGetBlockTransactionDto } from "@api-common/dtos/koios/block/koios-get-block-transaction.dto";
import { KoiosGetEpochBlockProtocolnDto } from "@api-common/dtos/koios/epoch/koios-get-epoch-block-protocols.dto";
import { KoiosGetEpochInformationDto } from "@api-common/dtos/koios/epoch/koios-get-epoch-information.dto";
import { KoiosGetEpochProtocolParametersDto } from "@api-common/dtos/koios/epoch/koios-get-epoch-protocol-parameters.dto";
import { KoiosGetTipInformationDto } from "@api-common/dtos/koios/koios-get-tip-information.dto";
import { KoiosGetPoolRegistrationsDto } from "@api-common/dtos/koios/pool/koios-get-pool-registration.dto";
import { KoiosGetScriptHashDto } from "@api-common/dtos/koios/script/koios-get-script-hash.dto";
import { KoiosGetTransactionInfoDto } from "@api-common/dtos/koios/transaction/koios-get-transaction-info.dto";
...
export async function koiosService() {
  ...
  const getAssetHistory = async (
    ...
    const getAssetHistory: string[] = getAssetHistoryDataArrayResponse.map(
