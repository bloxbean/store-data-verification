...
test.describe("@regression @integration", () => {
  ...
  test("Check the logic of create-node with --start flag", async ({}) => {
    test.step("GIVEN: Execute create-node command with --start flag", async () => {
      let createNodeCommand = "create-node -o --start";
